...
class Rectangle(Shape):
    def draw(self, window):
        ...
        # Draw the rectangle
        pygame.draw.rect(window.GetSurface(), self.color, pygame.Rect([(x1, y1), (x2, y2)]))
...
class Oval(Shape):
    def draw(self, window):
        ...
        pygame.draw.ellipse(window.GetSurface(), self.color, pygame.Rect([(x1, y1), (x2-x1, y2-y1)]))
...
class Triangle(Shape):
    ...
    def draw(self, window):
        ...
        # Draw a triangle
        pygame.draw.polygon(window.GetSurface(), self.color, [(x1, y1),(x2, y2),(x3, y3)])
...
class Text(Shape):
    ...
    def draw(self, window):
        window.GetSurface().blit(self._font.render(self._text, 1, self.color), (self.x1, self.y1))
